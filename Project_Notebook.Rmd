...
```{r, results='hide',fig.width=24, fig.height=10}
sarima.for(sales10to17.ts, 25, 0,1,1, 0,1,0, 12, pch = 20, lwd = 2)
```

We can also overlay the actual values to assess the accuracy of our forecasts.

```{r, results='hide',echo = FALSE,fig.width=24, fig.height=10}
sarima.for(sales10to17.ts, 25, 0,1,1, 0,1,0, 12, pch = 20, lwd = 2)
lines(sales18to19.ts, lwd = 2, lty = 2, col = 'midnightblue', type="o", pch = 4)
legend('topleft'
